...
var owl = $(".second-home").owlCarousel({
    ...
    nav: !0,
    dots: !1,
    navText: ['<i class="las la-arrow-right" aria-hidden="true"></i>  Perv ', 'Next  <i class="las la-arrow-left" aria-hidden="true"></i> '],
    responsive: {0: {items: 2}, 600: {items: 3}, 1000: {items: 4}}
});
...
function ApplyFileValidationRules(t) {
    return 0 == CheckFileType(t.type) ? (alert("The file (" + t.name + ") does not match the upload conditions, You can only upload jpg/png/gif files"), void e.preventDefault()) : 0 == CheckFileSize(t.size) ? (alert("The file (" + t.name + ") does not match the upload conditions, The maximum file size for uploads should not exceed 10 MB"), void e.preventDefault()) : 0 == CheckFilesCount(AttachmentArray) ? (filesCounterAlertStatus || (filesCounterAlertStatus = !0, alert("You have added more than 10 files. According to upload conditions you can upload 10 files maximum")), void e.preventDefault()) : void 0
}
...
$(".quantity input").change(function () {
    ...
    $(".example2").DataTable({
        bPaginate: !1,
        dom: "Bfrtip",
        buttons: [{extend: "colvis", postfixButtons: [{extend: "colvisRestore"}]}]
    })
